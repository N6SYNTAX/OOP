...
namespace SwinAdventure
{
    class Program
    {
        ...
        //private enum Commands {LookCommand, PeekCommand, MoveCommand}
        static void Main()
        {
            ...
            while (true)
            {
                ...
                else if (words[0] == commands[1])
                {
                    ...
                    Console.WriteLine(peek.Execute(Player, words));
                }
                else if (words[0] == commands[2])
                {
                    //var words = command.Split(' ', StringSplitOptions.RemoveEmptyEntries);
                    System.Console.WriteLine(commands[2]);
                    Console.WriteLine(move.Execute(Player, words));
                }
